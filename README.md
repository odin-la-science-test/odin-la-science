...
### Backend (Alternative à Vercel)
⚠️ **Important** : Vercel ne supporte pas Java/Spring Boot. Le backend doit être déployé sur une plateforme alternative :
...
Le backend utilise H2 en mémoire pour le développement. Pour la production, configurez PostgreSQL ou MySQL dans `application-prod.properties`.
